...
import Styled from "./create_subadmin_modal.module.css"

const CreateSubAdmin = ({ refetch }) => {
    ...
    return (
        ...
        <>
            ...
            <div className={Styled.createbtn}>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Create new SubAdmin</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form>
